    ...
    public partial class SeedData : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.AlterColumn<DateTime>(
                ...
                table: "Orders",
                nullable: false,
                defaultValue: new DateTime(2022, 10, 5, 13, 44, 39, 755, DateTimeKind.Local).AddTicks(8765),
                oldClrType: typeof(DateTime),
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2022, 10, 5, 10, 55, 38, 981, DateTimeKind.Local).AddTicks(8752));
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "en-US", false, "Tiếng việt" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "DateCreated", "OriginalPrice", "Price", "SeoAlias" },
                values: new object[] { 1, new DateTime(2022, 10, 5, 13, 44, 39, 763, DateTimeKind.Local).AddTicks(7541), 100000m, 200000m, null });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                type: "datetime2",
                nullable: false,
                defaultValue: new DateTime(2022, 10, 5, 10, 55, 38, 981, DateTimeKind.Local).AddTicks(8752),
                oldClrType: typeof(DateTime),
                oldDefaultValue: new DateTime(2022, 10, 5, 13, 44, 39, 755, DateTimeKind.Local).AddTicks(8765));
        }
    }
}
